const galleryData = {
    ...
    people: ['agung-prayoga-r5ygkIlNNE4-unsplash.jpg', 'alghozy-nGh-7uMHT98-unsplash.jpg', 'kamara-rahmat-1GeBFmg0Xa0-unsplash.jpg', 'kamara-rahmat-tezBLHCZ7ao-unsplash.jpg', 'round-icons-r9M-Qe6Thgc-unsplash.jpg'],
    streets: ['aliaksei-lepik-goa_pgKhAnI-unsplash.jpg', 'artur-adilkhanian-EIo9tWYAFc4-unsplash.jpg', 'bruno-bd-FFGHpRop-DU-unsplash.jpg', 'chris-weiher-xlAfCD2vOxQ-unsplash.jpg', 'gabriele-merlino-fa5so58oDAI-unsplash.jpg', 'martin-bennie-MhYU5K4A93I-unsplash.jpg', 'ruben-mavarez-wWcadZJcsYM-unsplash.jpg', 'the-metropolitan-museum-of-art-S2WA31buOIA-unsplash.jpg'],
};
...
for (const category in galleryData) {
    ...
    galleryData[category].forEach(image => {
        ...
        // gridImages.appendChild(imgLink);
    });
